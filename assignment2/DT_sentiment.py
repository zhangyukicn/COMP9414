...
df_data_file_training = pandas.read_csv(data_file_training, sep = '\t', header=None, names=['number','text','attitude'], nrows=4000)
df_test_file_training = pandas.read_csv(data_file_training, sep = '\t', header=None, names=['number','text','attitude'], skiprows=4000)
#print(len(df_test_file_training))


sentence_to_train = numpy.array(df_data_file_training['text'])
sentence_to_test= numpy.array(df_test_file_training['text'])
test_id = numpy.array(df_test_file_training['number'])
train_attitude = numpy.array(df_data_file_training['attitude'])
test_attitude = numpy.array(df_test_file_training['attitude'])
